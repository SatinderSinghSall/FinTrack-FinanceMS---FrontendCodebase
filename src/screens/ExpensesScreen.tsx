  ...
  const filteredExpenses = useMemo(() => {
    ...
    const filtered = expenses.filter((e) => {
      ...
      if (selectedCalendarDay) {
        const expenseDayStr = expenseDate.toISOString().split("T")[0];
        matchesDate = expenseDayStr === selectedCalendarDay;
      } else {
    ...
    <SafeAreaView className="flex-1 bg-slate-50">
      ...
      <View className="flex-row items-center justify-between px-6 py-3.5 bg-white border-b border-slate-100 shadow-sm">
        ...
        <Pressable
          ...
          className="w-10 h-10 rounded-2xl bg-red-50 items-center justify-center active:bg-red-100 border border-red-100"
        >
            ...
            >
              ...
              {viewMode === "calendar" && (
                <View className="bg-slate-50 p-4 rounded-3xl border border-slate-100 mb-6">
                  ...
                  {/* FIXED CALENDAR LAYOUT WITH SAFE SPACING TO AVOID OVERLAPS */}
                  <View className="flex-row flex-wrap">
                    {calendarDays.map((item, index) => {
                      ...
                      const hasExpenseOnDay = expenses.some((e) =>
                        e.date?.startsWith(item.dateString),
                      );
                      const isSelected =
                        ...
                        >
                          <Pressable
                            onPress={() => {
                              ...
                              setShowFilterModal(false); // Closes modal to restore active navigation context
                            }}
                            style={{ flex: 1 }}
                          ...
                          >
                            ...
                            {hasExpenseOnDay && !isSelected && (
                              <View className="absolute bottom-1.5 w-1 h-1 rounded-full bg-red-600" />
                            )}
                          </Pressable>
                        </View>
                      );
      ...
      {/* UPGRADED EXPENSE DETAILS MODAL */}
              ...
              <>
                ...
                >
                  <View className="items-center mt-1">
                    <View className="w-20 h-20 rounded-3xl bg-red-600 items-center justify-center shadow-xl shadow-red-600/30 mb-4">
                      <Ionicons name="receipt" size={36} color="white" />
                    </View>
                    ...
                    <View className="flex-row items-center bg-red-100 px-4 py-1.5 rounded-full mt-3">
                      <Ionicons
                        name="checkmark-circle"
                        size={14}
                        color="#dc2626"
                      />
                      <Text className="text-red-700 text-xs font-bold uppercase tracking-wider ml-1.5">
                  ...
                  <View className="bg-white rounded-3xl p-5 mt-6 border border-slate-100 shadow-sm">
                    ...
                    <View className="flex-row items-center justify-between py-3.5 border-b border-slate-100">
                      ...
                      <View className="items-end">
                        ...
                        <Text className="text-slate-400 text-xs font-medium mt-0.5">
                          {new Date(selectedExpense.date).toLocaleTimeString(
                            [],
                    ...
                    <View className="flex-row items-center justify-between py-3.5 border-b border-slate-100">
                      ...
                      <View className="items-end">
                        <Text className="text-slate-900 font-bold text-sm">
                          {new Date(
                            selectedExpense.updatedAt || selectedExpense.date,
        ...
        >
          <View className="mb-5">
            ...
            <Text className="text-slate-500 font-medium text-sm mt-0.5">
              Keep your spending in check effortlessly
            </Text>
          </View>
          ...
          <View className="bg-white rounded-3xl p-5 mb-5 flex-row justify-between items-center border border-slate-100 shadow-sm">
            <View>
              <Text className="text-slate-400 text-xs font-bold uppercase tracking-wider">
                {selectedCalendarDay
                  ? `Outflow on ${selectedCalendarDay}`
                  : "Filtered Outflow"}
              </Text>
            ...
            <View className="bg-red-50 px-3.5 py-1.5 rounded-2xl border border-red-100">
          ...
          >
            {categories.map((cat) => (
              ...
              >
                <Text
                  className={`font-bold text-xs ${
                    categoryFilter === cat ? "text-white" : "text-slate-600"
                  }`}
                >
                  {cat}
                </Text>
          ...
          <Pressable
            ...
            className="bg-red-600 py-4 rounded-2xl mb-6 flex-row items-center justify-center shadow-lg shadow-red-600/30 active:opacity-90"
          >
